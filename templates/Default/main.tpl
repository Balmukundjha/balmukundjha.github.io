...
<body>
			...
			<div class="conteiner">
				<div class="midside">
					...
					<section id="content">
						...
						<div class="box">
							<h1 class="heading h4">Latest Comments</h1>
							<div class="com_list">
								{content}
							</div>
						</div>
	...
	[available=lostpassword|register]
		<div class="page_form">
			<a class="page_form__back" href="/" title="Return to Homepage"><svg class="icon icon-left"><use xlink:href="#icon-left"></use></svg></a>
